...
> 🔴 **VIOLATION:** Invoking specialist agents without a verified plan file = FAILED orchestration.
...
#    "No plan file found. Use project-planner to create {task-slug}.md."
...
→ After plan file created → Resume orchestration
```
