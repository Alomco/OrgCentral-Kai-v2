...
async function NotInvitedContent({ next, tenant }: NotInvitedContentProps) {
    ...
    return (
        ...
        >
            <div className="relative w-full max-w-4xl overflow-hidden rounded-3xl bg-linear-to-br from-[hsl(var(--background))] via-[hsl(var(--card))] to-[hsl(var(--muted))] p-10 shadow-[0_25px_90px_-40px_hsl(var(--primary)/0.65)] motion-reduce:transition-none">
                <div className="pointer-events-none absolute -left-24 -top-28 h-72 w-72 rounded-full bg-[hsl(var(--primary)/0.25)] blur-3xl motion-safe:animate-pulse motion-reduce:animate-none" />
                <div className="pointer-events-none absolute -right-16 bottom-0 h-64 w-64 rounded-full bg-[hsl(var(--accent)/0.25)] blur-3xl motion-safe:animate-pulse motion-reduce:animate-none" />
                ...
                <div className="grid items-center gap-10 lg:grid-cols-[240px,1fr]">
                    <div className="relative flex justify-center">
                        <div className="absolute inset-0 rounded-2xl bg-linear-to-br from-[hsl(var(--primary)/0.25)] via-[hsl(var(--accent)/0.18)] to-[hsl(var(--chart-3)/0.2)] blur-3xl motion-reduce:blur-xl" />
                        <div className="relative flex h-56 w-56 items-center justify-center rounded-2xl bg-[hsl(var(--card)/0.9)] shadow-2xl backdrop-blur-md motion-reduce:backdrop-blur-0">
                            <Image
                                src={notInvitedImage}
                    ...
                    <div className="space-y-6">
                        <div className="inline-flex items-center gap-2 rounded-full bg-[hsl(var(--secondary)/0.35)] px-3 py-1 text-xs font-semibold uppercase tracking-wide text-[hsl(var(--foreground))] shadow-[0_10px_35px_-20px_hsl(var(--primary)/0.8)] backdrop-blur">
                            <span className="meta text-[10px] font-semibold text-[hsl(var(--foreground))]">Access pending</span>
                            <span className="rounded-full bg-[hsl(var(--accent)/0.22)] px-2 py-0.5 text-[10px] font-semibold uppercase text-[hsl(var(--accent))] shadow-sm">
                                Org {tenant.orgId}
                            </span>
                        </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="text-sm text-[hsl(var(--foreground))] opacity-75">
                        ...
                        <div className="flex flex-wrap gap-3">
                            ...
                            <Button
                                ...
                                variant="ghost"
                                size="lg"
                                className={`bg-[hsl(var(--card)/0.7)] px-6 text-[hsl(var(--foreground))] hover:bg-[hsl(var(--card)/0.9)] ${styles.ctaGlow} motion-safe:translate-y-0 motion-safe:hover:-translate-y-px`}
                            >
                                <Link href={supportHref}>Contact support</Link>
                            </Button>
                        </div>

                        <div className="space-y-4 rounded-2xl bg-[hsl(var(--card)/0.12)] p-5 backdrop-blur-md shadow-[0_10px_40px_-30px_hsl(var(--primary)/0.5)]">
                            <p className="text-xs font-semibold uppercase tracking-[0.12em] text-[hsl(var(--foreground))] opacity-70">
                                Quick checklist
                            </p>
                            <ul className="space-y-3 text-sm text-[hsl(var(--foreground))] opacity-85">
                                <li className="flex gap-3">
                                    <span className="mt-1 inline-flex h-6 w-6 items-center justify-center rounded-full bg-[hsl(var(--accent)/0.18)] text-xs font-semibold text-[hsl(var(--accent-foreground))] shadow-inner">
                                        1
                                    </span>
                                    <div className="space-y-1">
                                        <p className="font-semibold text-[hsl(var(--foreground))]">Ask your org admin for an invite</p>
                                        <p className="text-[hsl(var(--foreground))] opacity-75">
                                            Only workspace admins can add members. Use the email address they have on file for you.
                                        </p>
                                    </div>
                                </li>
                                <li className="flex gap-3">
                                    <span className="mt-1 inline-flex h-6 w-6 items-center justify-center rounded-full bg-[hsl(var(--chart-3)/0.18)] text-xs font-semibold text-[hsl(var(--primary-foreground))] shadow-inner">
                                        2
                                    </span>
                                    <div className="space-y-1">
                                        <p className="font-semibold text-[hsl(var(--foreground))]">Try a different account</p>
                                        <p className="text-[hsl(var(--foreground))] opacity-75">
                                ...
                                <li className="flex gap-3">
                                    <span className="mt-1 inline-flex h-6 w-6 items-center justify-center rounded-full bg-[hsl(var(--primary)/0.16)] text-xs font-semibold text-[hsl(var(--primary-foreground))] shadow-inner">
                                        3
                                    </span>
                                    <div className="space-y-1">
                                        <p className="font-semibold text-[hsl(var(--foreground))]">Still stuck?</p>
                                        <p className="text-[hsl(var(--foreground))] opacity-75">
                ...
                <div className="mt-6 flex items-center justify-center gap-2 text-xs text-[hsl(var(--foreground))] opacity-75">
