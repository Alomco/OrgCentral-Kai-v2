...
import { deleteDocumentTemplateAction } from '../actions';
...
export interface DocumentTemplateDeleteFormProps {
    templateId: string;
}

export function DocumentTemplateDeleteForm({ templateId }: DocumentTemplateDeleteFormProps) {
    const [state, formAction, pending] = useActionState(
        async (_previousState: ActionState, formData: FormData) => deleteDocumentTemplateAction(formData),
        initialState,
    );
