...
export function LeavePolicyDeleteForm(props: { policyId: string }) {
    ...
    return (
        ...
        >
            ...
            <AlertDialog open={confirmOpen} onOpenChange={setConfirmOpen}>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This cannot be undone. Policies in use by balances or requests cannot be deleted.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
            ...
            {state.status === 'error' ? (
                <p className="text-xs text-destructive">{state.message ?? 'Unable to delete policy.'}</p>
            ) : null}
        </form>
    );
}
