...
import {
    listBillingAssignmentsController,
    assignBillingPlanController,
...
export async function GET(request: Request) {
    try {
        const result = await listBillingAssignmentsController(request);
...
export async function POST(request: Request) {
    try {
        const result = await assignBillingPlanController(request);
